...
public abstract class AbstractBasePubSubConsumer<T> {
    ...
    try {
      final T message =
          objectMapper.readValue(
              basicAcknowledgeablePubsubMessage.getPubsubMessage().getData().toStringUtf8(),
              getMessageClass());
  ...
  protected void determineAckMessageResponse(
      final BasicAcknowledgeablePubsubMessage basicAcknowledgeablePubsubMessage,
